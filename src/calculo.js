...
function calcularJurosComposto(valor, taxaAoMes, tempo_em_meses ){
...
function receberValores(valor, taxaAoMes, tempo_em_meses){
    ...
    return calcularJurosComposto(valor, taxaAoMes, tempo_em_meses)
}

receberValores();

module.exports = {calcularJurosComposto, receberValores}